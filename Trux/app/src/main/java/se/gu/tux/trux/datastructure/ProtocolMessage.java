...
public class ProtocolMessage extends Data {
    public enum Type {LOGIN_SUCCESS, LOGIN_FAILED, AUTO_LOGIN_REQUEST, LOGOUT_REQUEST, DATA_RECEIVED,
        SUCCESS, ERROR, INVALID_SESSION, PEOPLE_SEARCH, FRIEND_REQUEST, FRIEND_REQUEST_SEEN,
        FRIEND_REMOVE,ACCEPT_FRIEND, DECLINE_FRIEND, GOODBYE, GET_LATEST_CONVERSATIONS,
        GET_LATEST_MESSAGES, GET_UNREAD_MESSAGES, MESSAGE_SEEN, GET_ONLINE_FRIENDS,
