...
#### Message page 
In the normal state the user is able to chat and type messages freely. In the driving mode the user can only choose from predefined messages. 
Message pagePredefined Messages in driving mode 
