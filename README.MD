...
* After this is done merge out with your new feature branch: <b>git branch FEATURENAME</b>
...
* Do you usual stuff: <b>git add FILES</b> and <b>git commit -m "YOUR MESSAGE"</b>
